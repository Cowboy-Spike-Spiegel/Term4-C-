    ...
    , ui(new Ui::Widget)
{
    ...
    ui->textEdit_record->setFont(QFont("Consolas",10,75)) ;
    ui->textEdit_record->setStyleSheet("background: rgba(255,255,255,50%)") ;
    ...
    connect( server, &QTcpServer::newConnection, this, [=]() {
        ...
        connect( socket, &QTcpSocket::readyRead, this, [=]() {
            ...
            ui->textEdit_record->append("client:");
...
void Widget::reply() {
    ...
    socket->write(array);
    ui->textEdit_record->append("server:");
    ui->textEdit_record->append("   "+array);
    ui->textEdit_record->append("");
}
