...
public:
    Good();
    virtual ~Good();
    virtual void create(int sender, int receiver, int weight, QString discription);
    virtual void create(int number, int sender, int receiver, QString time_s, QString time_r, int weight, int s, QString dis, int c);
